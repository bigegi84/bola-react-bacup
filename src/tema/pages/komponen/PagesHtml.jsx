...
class PagesHtml extends React.Component{
  state={
    jqueryDimuat:false
  }
  render(){
    ...
    return(
      ...
      <head>
        ...
        <link href="/tema/pages/html/assets/plugins/pace/pace-theme-flash.css" rel="stylesheet" type="text/css" />
        <link href="/tema/pages/html/assets/plugins/boostrapv3/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="/tema/pages/html/assets/plugins/font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css" />
        <link href="/tema/pages/html/assets/plugins/jquery-scrollbar/jquery.scrollbar.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="/tema/pages/html/assets/plugins/bootstrap-select2/select2.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="/tema/pages/html/assets/plugins/switchery/css/switchery.min.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="/tema/pages/html/pages/css/pages-icons.css" rel="stylesheet" type="text/css"/>
        <link class="main-stylesheet" href="/tema/pages/html/pages/css/pages.css" rel="stylesheet" type="text/css" />
        {/*[if lte IE 9]>*/}
      {/*<link href="/tema/pages/html/assets/plugins/codrops-dialogFx/dialog.ie.css" rel="stylesheet" type="text/css" media="screen" />*/}
      </head>
        ...
        <div class="sidebar-header">
          <img
            ...
            <div class="sidebar-header-controls">
              <button type="button" class="btn btn-xs sidebar-slide-toggle btn-link m-l-20" data-pages-toggle="#appMenu"><i class="fa fa-angle-down fs-16"/>
              </button>
              <button type="button" class="btn btn-link visible-lg-inline" data-toggle-pin="sidebar"><i class="fa fs-12"/>
              </button>
            </div>
        </div>
        ...
        <div class="sidebar-menu">
          ...
          <ul class="menu-items">
            <li class="m-t-30 ">
              ...
              <span class="bg-success icon-thumbnail"><i class="pg-home"/></span>
            </li>
            <li class="">
            ...
            <li class="">
              ...
              <span class="icon-thumbnail"><i class="pg-mail"/></span>
            </li>
            <li class="">
              <a href="social.html"><span class="title">Social</span></a>
              <span class="icon-thumbnail"><i class="pg-social"/></span>
            </li>
            <li>
              <a href="javascript:;"><span class="title">Calendar</span>
                <span class=" arrow"/></a>
              <span class="icon-thumbnail"><i class="pg-calender"/></span>
              <ul class="sub-menu">
                <li class="">
            ...
            <li class="">
              ...
              <span class="icon-thumbnail"><i class="pg-layouts"/></span>
            </li>
            <li>
              <a href="javascript:;"><span class="title">Layouts</span>
                <span class=" arrow"/></a>
              <span class="icon-thumbnail"><i class="pg-layouts2"/></span>
              <ul class="sub-menu">
                <li class="">
            ...
            <li>
              ...
              <span class="icon-thumbnail"><i class="pg-form"/></span>
              <ul class="sub-menu">
                <li class="">
            ...
            <li class="">
              ...
              <span class="icon-thumbnail"><i class="pg-grid"/></span>
            </li>
            <li class="">
              <a href="views.html">
                <span class="title">Views</span>
              </a>
              <span class="icon-thumbnail"><i class="pg pg-ui"/></span>
            </li>
            <li>
              <a href="javascript:;"><span class="title">Tables</span>
                <span class=" arrow"/></a>
              <span class="icon-thumbnail"><i class="pg-tables"/></span>
              <ul class="sub-menu">
                <li class="">
            ...
            <li>
              <a href="javascript:;"><span class="title">Maps</span>
                <span class=" arrow"/></a>
              <span class="icon-thumbnail"><i class="pg-map"/></span>
              <ul class="sub-menu">
                <li class="">
            ...
            <li class="">
              ...
              <span class="icon-thumbnail"><i class="pg-charts"/></span>
            </li>
            <li>
              <a href="javascript:;"><span class="title">Extra</span>
                <span class=" arrow"/></a>
              <span class="icon-thumbnail"><i class="pg-bag"/></span>
              <ul class="sub-menu">
                <li class="">
            ...
            <li class="">
              <a href="javascript:;"><span class="title">Menu Levels</span>
                <span class="arrow"/></a>
              <span class="icon-thumbnail"><i class="pg-menu_lv"/></span>
              <ul class="sub-menu">
                <li>
      ...
      <div class="page-container ">
        ...
        <div class="header ">
          ...
          <div class=" pull-left sm-table hidden-xs hidden-sm">
            <div class="header-inner">
              ...
              <ul class="notification-list no-margin hidden-sm hidden-xs b-grey b-l b-r no-style p-l-30 p-r-20">
                ...
                <li class="p-r-15 inline">
                  <a href="#" class="icon-set clip "/>
                </li>
                <li class="p-r-15 inline">
                  <a href="#" class="icon-set grid-box"/>
                </li>
              </ul>
          ...
          <div class=" pull-right">
            <div class="header-inner">
              <a href="#" class="btn-link icon-set menu-hambuger-plus m-l-20 sm-no-margin hidden-sm hidden-xs" data-toggle="quickview" data-toggle-element="#quickview"/>
            </div>
          </div>
          <div class=" pull-right">
            {/* START User Info*/}
      ...
      <div id="quickview" class="quickview-wrapper" data-pages="quickview">
        ...
        <div class="tab-content">
              ...
              <div class="view list" id="quick-note-list">
                <div class="toolbar clearfix">
                  <ul class="pull-right ">
                    ...
                    <li>
                      <a href="#" class="new-note-link" data-navigate="view" data-view-port="#note-views" data-view-animation="push"><i class="fa fa-plus"/></a>
                    </li>
                  </ul>
                ...
                <ul>
                  ...
                  <li data-noteid="1">
                    ...
                    <div class="right pull-right">
                      ...
                      <a href="#" data-navigate="view" data-view-port="#note-views" data-view-animation="push"><i class="fa fa-chevron-right"/></a>
                      {/* END Note Date !*/}
                    </div>
                    {/* END Note Details !*/}
                  </li>
              ...
              <div class="view note" id="quick-note">
                <div>
                  <ul class="toolbar">
                    ...
                    <li><a href="#" data-action="Bold"><i class="fa fa-bold"/></a>
                    </li>
                    <li><a href="#" data-action="Italic"><i class="fa fa-italic"/></a>
                    </li>
                    <li><a href="#" class=""><i class="fa fa-link"/></a>
                    </li>
                  </ul>
                  <div class="body">
                    <div>
          ...
          data-src-retina="assets/img/profiles/7x.jpg" data-src="assets/img/profiles/7.jpg"
      ...
      {/* END OVERLAY */}
      {/* BEGIN VENDOR JS */}
      <Script url="/tema/pages/html/assets/plugins/pace/pace.min.js"/>
      <Script
        url="/tema/pages/html/assets/plugins/jquery/jquery-1.11.1.min.js"
        onLoad={() => {
      ...
      {jqueryDimuat?
        (
          <div>
            <Script url="/tema/pages/html/assets/plugins/modernizr.custom.js" />
            <Script url="/tema/pages/html/assets/plugins/jquery-ui/jquery-ui.min.js" />
            <Script url="/tema/pages/html/assets/plugins/boostrapv3/js/bootstrap.min.js" />
            <Script url="/tema/pages/html/assets/plugins/jquery/jquery-easy.js" />
            <Script url="/tema/pages/html/assets/plugins/jquery-unveil/jquery.unveil.min.js" />
            <Script url="/tema/pages/html/assets/plugins/jquery-bez/jquery.bez.min.js"/>
            <Script url="/tema/pages/html/assets/plugins/jquery-ios-list/jquery.ioslist.min.js" />
            <Script url="/tema/pages/html/assets/plugins/jquery-actual/jquery.actual.min.js"/>
            <Script url="/tema/pages/html/assets/plugins/jquery-scrollbar/jquery.scrollbar.min.js"/>
            <Script  url="/tema/pages/html/assets/plugins/bootstrap-select2/select2.min.js"/>
            <Script  url="/tema/pages/html/assets/plugins/classie/classie.js"/>
            <Script url="/tema/pages/html/assets/plugins/switchery/js/switchery.min.js" />
            {/* END VENDOR JS */}
            {/* BEGIN CORE TEMPLATE JS */}
            <Script url="/tema/pages/html/pages/js/pages.min.js"/>
            {/* END CORE TEMPLATE JS */}
            {/* BEGIN PAGE LEVEL JS */}
            <Script url="/tema/pages/html/assets/js/scripts.js" />
          </div>
        ):'not'}
      </body>
      </html>
